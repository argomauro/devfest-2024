        ...
        <v-col md="12">
          <v-container fluid class="ma-0 pa-0 mt-8">
            ...
            <v-row align="start" justify-start>
              <v-col md="12">
                <p>
                  Tutti i partecipanti all'evento DevFest 2025, inclusi i partecipanti online, lo staff dell'evento e i
                  relatori, devono rispettare la seguente politica:
                </p>
                <li v-for="policy in policiesData" :key="policy">
                  {{ policy }}
                </li>
              </v-col>
            </v-row>
...
<script setup>
const {cocData, mainData, policiesData} = useJSONData();
